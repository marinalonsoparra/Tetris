...
def frame_scores(left_frame, score, level, line, font_tetrix):
    ...
    label_score = Label(left_frame, text="SCORE", fg="white", font=font_tetrix, background="grey")
    ...
    label_level = Label(left_frame, text="LEVEL", fg="white", font=font_tetrix, background=frame_background_color)
    ...
    label_line = Label(left_frame, text="LINES", fg="white", font=font_tetrix, background=frame_background_color)
